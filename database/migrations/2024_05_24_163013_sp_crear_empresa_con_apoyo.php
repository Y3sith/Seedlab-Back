...
return new class extends Migration
{
    ...
    IN p_id_municipio VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
    IN p_id_emprendedor VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ,
    ...
    IN p_idTipoDocumentoApoyo INT ,
    In p_id_empresa VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci
)
BEGIN
    ...
    ELSE
        ...
        SELECT id INTO v_idMunicipio FROM municipios WHERE nombre = p_id_municipio LIMIT 1;
        ...
        VALUES (p_documentoEmpresa, p_nombreEmpresa, p_cargoEmpresa, p_razonSocial, p_urlPagina, p_telefonoEmpresa, p_celularEmpresa, p_direccionEmpresa, p_profesion, p_correoEmpresa, p_experiencia, p_funciones, p_idTipoDocumentoEmpresa, v_idMunicipio, p_id_emprendedor);
        ...
        IF p_documentoApoyo IS NOT NULL THEN
            INSERT INTO apoyo_empresa (documento, nombre, apellido,  cargo, telefono, celular, email, id_tipo_documento, id_empresa)
            VALUES (p_documentoApoyo, p_nombreApoyo, p_apellidoApoyo,  p_cargoApoyo, p_telefonoApoyo, p_celularApoyo, p_correoApoyo, p_idTipoDocumentoApoyo, @id_empresa);
        END IF;
    END IF;
END
');
