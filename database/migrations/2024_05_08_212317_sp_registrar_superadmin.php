...
return new class extends Migration
{
    ...
    ELSE
        ...
        INSERT INTO superadmin (nombre, apellido, id_autentication, celular, imagen_perfil, direccion, genero) 
        VALUES (p_nombre, p_apellido, last_inserted_id, p_celular, p_imagen_perfil, p_direccion, p_genero);
